...
//             }}
//             className="bg-white rounded-2xl p-5 sm:p-6 text-center shadow-xl border border-gray-100 cursor-pointer group transition-all duration-300"
//           >
//             <div className="flex justify-center mb-3 group-hover:scale-110 transition-transform duration-300 text-xl">
//               {card.icon}
//             </div>
//             <h4 className="font-bold text-gray-800 mb-2 text-base sm:text-lg lg:text-xl">
//               {card.label}
//             </h4>
...
export default function ServiceFeature() {
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10 sm:-mt-14 lg:-mt-16 relative z-10">
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 lg:gap-6">
        {featureCards.map((card, i) => (
          <motion.div
            ...
            className="bg-white rounded-2xl p-5 sm:p-6 lg:p-7 text-center shadow-xl border border-gray-100 transition-all duration-300 cursor-pointer h-full"
          >
            <div className="flex justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
              {card.icon}
            </div>

            <h4 className="font-bold text-gray-800 text-lg sm:text-xl mb-3">
              {card.label}
            </h4>

            <p className="text-gray-500 text-sm sm:text-base leading-7">
              Pelentesque facilisis. Nulla imperdiet sit amet magna.
