        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-slate-300 font-bold text-[11px] tracking-wider uppercase">
            ...
            >
              InfoDrif helps affiliates discover high-converting offers,
              optimize campaigns, and maximize commissions through
            ...
            >
              ...
              <div className="flex -space-x-3">
                <img
                  className="w-10 h-10 rounded-full border-2 border-[#030611] object-cover"
              ...
              <div className="text-center sm:text-left">
                ...
                <div className="flex items-center gap-2 mt-1 justify-center sm:justify-start">
                  ...
                  <span className="text-slate-400 text-xs font-semibold">
                    4.9 <span className="text-slate-500">(15k Reviews)</span>
                  </span>
                </div>
              </div>
            </motion.div>
          ...
          > */}
          <div className="hidden md:flex lg:col-span-6 items-center justify-center relative min-h-[500px] lg:min-h-[600px] mt-8 lg:mt-0">
            ...
            {/* Sparkle Twinkles */}
            <div className="absolute top-[12%] right-[12%] text-blue-400/50 text-[10px] animate-pulse">
              ✦
            </div>
            <div className="absolute bottom-[30%] left-[5%] text-purple-400/40 text-base animate-pulse">
              ✦
            </div>
    ...
    "
            ...
            >
              ...
              <div className="w-full mt-3">
                <svg
                  viewBox="0 0 100 25"
                  className="w-full h-6 drop-shadow-[0_2px_4px_rgba(168,85,247,0.3)]"
                >
                  <path
            ...
            >
              <span className="text-white text-xs font-bold block mb-2.5">
                Team Members
              </span>
              <div className="flex items-center justify-between">
                ...
                <div className="flex -space-x-2">
                  ...
                  <img
                    className="w-8 h-8 rounded-full object-cover border-2 border-slate-950"
                    src="https://images.unsplash.com/photo-1501196354995-cbb51c65aaea?w=100"
                    alt="Team 4"
                  />
                </div>
